...
- `docs/image-strategy.md` — the featured-image/thumbnail strategy: one clean 4:5 master + plugin overlay, the upgraded image_prompt/discover_image_prompt formulas, the FREE default tool (Gemini via Google AI Studio = Nano Banana; §9 step-by-step), and the reject checklist. Higgsfield is the paid future upgrade.

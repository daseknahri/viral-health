...
- **Voice:** second person, present tense, "you/your body", warm, ~7th-grade level; **contractions by default** (it's, you're, can't); short paragraphs, scannable H2s; at least one calm **delight beat**; vary the nut-graf opener (no "It is one of…" / "Here's the twist:" stamp). Friend, not textbook.
- **Headings earn search too:** at least two H2s contain the core keyword or are a real search question ("How do you get rid of brain freeze fast?"), not mood-only labels ("What is actually happening").
- **Sections teach, don't sprawl:** 4–6 H2s, each ~110–180 words adding a NEW mechanism/cause/consequence; merge or cut a thin section (don't pad it); include one calm mid-article **escalation beat** (a clever proof / benign vivid example / counter-test).
- **Summary ends on an open loop** naming what the reader still doesn't know — not a fake cliffhanger.
- **Numbers only if real** and in the article; specific/odd over round; never invent/round/change units. **Claims only as strong as the evidence:** frame any single-study, mixed-replication, or competing-theory claim as a leading idea ("the leading theory is…"), never as settled fact — a confident wrong nuance costs more trust than an honest "researchers think".
- **Caption opens as a member, not a brand;** no URL and no word "link" in the caption (it lives in the image hint + first comment).
- **Engineer the second click:** end the article with ONE concrete same-theme nudge that NAMES a specific neighboring phenomenon the reader can picture and opens a small new loop ("the same nerve trick is why you stop feeling your socks within minutes") — prose only, no link/slug (the site adds internal links; the body stays URL-free). BANNED: "is worth a look too" / "worth a look", and any cue pointing at a vague "the way your body…" abstraction. Unique per article and per batch.
- **Banned everywhere:** the answer leaking; "amazing / top 10 / you won't believe / doctors hate this / one weird trick"; ALL CAPS or "!"; fake urgency ("now/today/breaking/before it's gone"); fear / "silent killer"; the crutch hook stamp (leading em-dash + "here's the surprising reason / quick fix") used as a default — vary openers so curiosity comes from the specific named trigger, not the word "surprising"; any diagnosis, cure, treatment, prevention, dosage, product-push, or invented stat. Prefer "may be linked to", "what it could mean", "general signs".
...
STYLE LOCKS: front-load curiosity in the first ~8 words of facebook_hook (full hook 60-90 chars); second person, present tense, "you/your body"; warm, calm, ~7th-grade level; CONTRACTIONS by default. End facebook_summary on an open loop naming what the reader still doesn't know (not a fake cliffhanger). overlay_text = the hook compressed to a 5-9 word STANDALONE CURIOSITY FRAGMENT (max 12): NOT the title/seo_title restated, NO terminal period, opens the SAME loop as facebook_hook (same withheld specific) — if removing the title makes it meaningless, or it answers its own question, rewrite it; "different from the title" never means "more cryptic" (if it makes the topic unpredictable, rewrite the title). VARY hook openers — "surprising", "here's the…", and the leading em-dash are crutches; curiosity must come from the specific named trigger, not the word "surprising". Numbers only if real and present in content_html; prefer specific/odd over round; never invent, round, or change units; frame single-study/competing-theory claims as "the leading idea is…", never as settled. Banned: "amazing / top 10 / you won't believe / doctors hate this / one weird trick", ALL CAPS, "!", fake urgency ("now / today / breaking / before it's gone"), fear / "silent killer".

SECOND-CLICK: end content_html with ONE sentence that NAMES a specific neighboring phenomenon the reader can picture and opens a small new loop (e.g. "the same nerve trick is why you stop feeling your socks within minutes of putting them on") — written inside content_html (not as a separate field), because only the article body renders on the page. BANNED: "is worth a look too" / "worth a look" and any vague "the way your body…" abstraction; make each article's cue unique.

SECTIONS + ESCALATION: content_html is 4-6 H2 sections, each ~110-180 words that teach something NEW (a mechanism/cause/consequence) — never a section that restates or only renames the phenomenon ("It even has a name"); merge or cut a thin section rather than padding it. Place ONE mid-article ESCALATION BEAT after the core mechanism — a clever proof, a benign vivid example (e.g. how much taller astronauts get in zero-g), or a counter-test — calm and non-scary. At least two H2s are search-legible (core keyword or a real question).

CONTESTED SCIENCE: every causal/explanatory claim is consensus OR explicitly framed as a leading idea / single study / competing theories; never state a contested claim as settled, and make any stated cause connect to any stated fix. "researchers found / studies show" only when the specific finding is real.
```

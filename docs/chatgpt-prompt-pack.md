...

{
  ...
  "image_prompt": "a ready-to-paste PORTRAIT-MASTER prompt for the featured 4:5 image (full formula in docs/image-strategy.md §4): ONE relatable everyday US adult doing a simple safe action tied to the topic (hands relaxed, holding a plain mug, or out of frame), calm/curious expression, CENTERED in the middle ~40-55% of the frame with the LOWER THIRD kept soft and low-detail as negative space for the text overlay; soft warm natural daylight, cozy modern US home, ONE subtle accent (sage-green OR muted-burgundy), 50mm f/2.0 shallow depth of field, realistic skin texture, no stock-photo look. End with exactly: Portrait orientation, 4:5, high resolution. No text, no words, no letters, no logos, no watermark, no numbers. One person only. Natural, undistorted hands and faces, correct number of fingers; no clinical, medical-procedure, or before/after imagery.",
